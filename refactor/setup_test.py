...
#### MBAR SPAGHETTI ####
    ...
    mbar, umb_centers_interp = create_mbar_umb(umb_centers, E_unbias_concat, r1N_concat, n_frames, k_umb, umb_T)

    print 'spaghetti math'

    Qi_vs_r1N, bin_mid, loops = mbar_spaghetti(dir_name_format, dir_name_data, 'SH3', r1N_concat, len(umb_centers_interp), mbar)
